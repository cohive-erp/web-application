package backend.cohive.api.configuration.security;

import backend.cohive.api.configuration.security.jwt.GerenciadorTokenJwt;
import backend.cohive.domain.service.usuario.autenticacao.AutenticacaoService;
...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/api/usuarios/reset-password"),
            new AntPathRequestMatcher("/api/relatorios/get-relatorio-csv"),
